...
for line in lines:
    ...
    if int(assignments[0]) >= int(assignments[2]) and int(assignments[0]) <= int(assignments[3]):
        print(assignments[0],"-",assignments[1], assignments[2],"-",assignments[3],"first")
        count+=1
    
    elif int(assignments[2]) >= int(assignments[0]) and int(assignments[2]) <= int(assignments[1]):
